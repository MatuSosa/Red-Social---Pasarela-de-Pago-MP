...
if(strlen($password) >= 6) {
    // Contraseña válida, continúa con el registro
} else {
    echo "La contraseña debe tener al menos 6 caracteres.";
    exit(); // Termina el script si la contraseña no es válida
}
                    ...
                    if(in_array($img_ext, $extensions) === true){
                        ...
                        if(in_array($img_type, $types) === true){
                            ...
                            if(move_uploaded_file($tmp_name,"images/".$new_img_name)){
                                ...
                                $status = "Activo ahora";
                                $encrypt_pass = password_hash($password, PASSWORD_DEFAULT); // Creates a password hash
